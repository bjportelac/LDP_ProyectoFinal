...
public class GraphicaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"From", "Import", "Graphica", "New", "Basic", "Objects", "Begin", "Graph", 
			"Coordinates", "Obj_Circle", "Fill", "RGB", "Stroke", "FillType", "IStyle", 
			"Circle", "Rectangle", "Square", "Ellipse", "Line", "Polyline", "Draw", 
			"L_Paren", "R_Paren", "L_Curly", "R_Curly", "Comma", "Period", "Semicolon", 
			"Assign", "Quote", "NL", "WS", "COMMENT", "LINE_COMMENT", "Digit", "Integer", 
			"Double", "ID"
		};
	}
